...
const Navbar = () => {
    return (
        <nav
            className="font-poppins flex items-center justify-between text-white text-sm fixed w-full top-0 z-50  backdrop-blur-md h-[48px] pt-2 px-6 lg:px-10 xl:px-12 2k:px-[10%]">
            <motion.div initial={"hidden"} animate={'visible'} variants={navItem}
                        className="flex items-center 2xl:text-2xl">WINN
            </motion.div>
            <motion.div initial={'hidden'} animate={'visible'} variants={navContainer}
