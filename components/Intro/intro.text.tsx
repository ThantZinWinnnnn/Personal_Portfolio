...
const IntroText = () => {
    return (
        <div id="home" data-scroll data-scroll-speed="0.3"
            ...
            <div className="flex flex-col gap-40 text-center mt-32 box-border w-full overflow-hidden justify-center">
                <div className="flex flex-col gap-10 sm:gap-14 overflow-hidden">
                    <motion.h1 initial={{opacity: 0, y: -50}} animate={{
                    ...
                    <motion.h2 initial={"hidden"} animate="visible" variants={textContainer}
                    ...
                    <motion.p initial={"hidden"} animate={"visible"} variants={developerText}
