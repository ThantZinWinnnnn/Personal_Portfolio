...
const Footer = () => {
  ...
  return (
    <footer className="py-8 relative text-white before:w-full before:absolute before:h-[2px] before:bg-[url('/images/dash.svg')] after:absolute after:h-[2px] after:w-full after:bg-[url('/images/dash.svg')]">
      <div className="flex justify-between mb-4">
        <div className="">
          <h5 className="my-4">Connection</h5>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  ...
                  >
                    ...
                    >
                      <path
                        className="group-hover:fill-green-400 group-active:fill-green-500"
                        fill-rule="evenodd"
                        clip-rule="evenodd"
        ...
        <div className="flex items-center gap-2">
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent>
                <p>{copySuccess ? "Successfully copied! 😁" : "Press to Copy"}</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </div>
