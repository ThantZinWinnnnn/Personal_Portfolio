...
const ProfileDetail = () => {
    return (
        <section
            id="about"
            data-scroll
            className="h-auto pb-12 text-white px-4 sm:px-16 lg:px-0 xl:px-16  max-w-[80rem] mx-auto mt-48 mb-20"
        >
            ...
            <div className="flex flex-col-reverse lg:flex-row">
                <div className="w-full text-center lg:text-left lg:w-[50%] lg:pr-24">
                    ...
                    <div
                        className="flex flex-col sm:flex-row  xl:flex-row gap-5 xl:gap-3 mt-14 justify-center lg:justify-start w-[85%] mx-auto lg:w-full">
                        <Link
                            to="contact"
                            smooth={true}
                            offset={-30}
                        ...
                        >
                            <ProfileButton
                                textColor="text-[#11122B]"
                                bgC="bg-white"
                                text="Contact Me"
                                icon={<IconMail className="group-hover:animate-bounce"/>}
